...
def index():
    player_response = requests.get("http://football_project_player_backend:5000/player")
    team_response = requests.get("http://football_project_team_backend:5000/team")
    result_response = requests.post(
        "http://football_project_result_backend:5000/result", 
